...
const Work = () => {
    return (
        <div id='work' className='px-[5%] mt-30 w-full max-sm:scroll-mt-20 md:scroll-mt-30 space-y-3' >
            <h2 className='text-gray-500 xl:text-lg '>My Portfolio</h2>
            <h2 className='font-bold mb-3 xl:text-xl mb-7'>My latest work</h2>
